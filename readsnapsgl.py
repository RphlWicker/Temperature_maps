...
def readhdf5head(filename, quiet=True):
    if not quiet:
...
def readhdf5data(filename, block, quiet=True, ptype=None):
    if not quiet:
...
def readsnap(filename, block, endian=None, quiet=True, longid=False, nmet=11, totnum=None,
    ...
    """
    readsnap(filename, block, endian=None, quiet=True, longid=False, nmet=11,
             fullmass=False, mu=None, fmt=None, ptype=None, rawdata=False
